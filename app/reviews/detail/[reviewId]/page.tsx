        ...
        <div className="md:col-span-1 space-y-6">
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    {(review.zoomLink || review.roomNumber) && (
                        <div className="pt-4 border-t border-zinc-100 dark:border-zinc-800 space-y-4">
                             {review.zoomLink && (
                                <div>
                                    <label className="block text-xs text-zinc-500 uppercase font-bold mb-1">Enlace de Zoom</label>
                                    <a 
                                        href={review.zoomLink} 
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className="text-blue-600 hover:text-blue-700 hover:underline break-all text-sm font-medium flex items-center gap-1"
                                    >
                             ...
                             {review.roomNumber && (
                                <div>
                                    <label className="block text-xs text-zinc-500 uppercase font-bold mb-1">Sala / Aula</label>
                                    <div className="text-zinc-900 dark:text-zinc-100 font-medium text-sm flex items-center gap-1">
                                        <svg className="w-4 h-4 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                                        {review.roomNumber}
                                    </div>
                                </div>
                             )}

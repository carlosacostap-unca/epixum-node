...
export default function ReviewsManager({ sprint, initialReviews, currentUser }: ReviewsManagerProps) {
  ...
  return (
    <div className="space-y-8">
        ...
        {/* Reviews List or My Booking Detail */}
        {isStudent && myBooking ? (
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-blue-200 dark:border-blue-900/50 shadow-md overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-6 border-b border-blue-100 dark:border-blue-900/30">
                ...
                <div className="p-8">
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="flex-1 space-y-8">
                            <div>
                                <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Horario</h3>
                                <div className="flex items-center gap-3 text-2xl font-light">
                                    <FormattedDate date={myBooking.startTime} showTime={true} />
                                    <span className="text-zinc-300">-</span>
                                    <FormattedDate date={myBooking.endTime} showTime={true} />
                                </div>
                            </div>

                            {(myBooking.zoomLink || myBooking.roomNumber) && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-5 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-100 dark:border-zinc-800">
                                    {myBooking.zoomLink && (
                                        <div>
                                            <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Enlace de Zoom</h3>
                                            <a 
                                                href={myBooking.zoomLink} 
                                                target="_blank" 
                                                rel="noopener noreferrer"
                                                className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium hover:underline break-all"
                                            >
                                    ...
                                    {myBooking.roomNumber && (
                                        <div>
                                            <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Sala / Aula</h3>
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-zinc-500 uppercase tracking-wider mb-2">Estado</h3>
                        ...
                        <div className="flex flex-col gap-3 justify-center border-t md:border-t-0 md:border-l border-zinc-200 dark:border-zinc-800 pt-6 md:pt-0 md:pl-8 min-w-[250px]">
                             <Link 
                                href={`/reviews/detail/${myBooking.id}`}
                                className="w-full px-6 py-3 bg-white border border-zinc-200 text-zinc-700 hover:bg-zinc-50 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-700 rounded-xl transition-all font-medium text-center shadow-sm flex items-center justify-center gap-2"
                            >
                            ...
                            <button 
                                ...
                                disabled={isPending}
                                className="w-full px-6 py-3 bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30 rounded-xl transition-all font-medium flex items-center justify-center gap-2"
                            >
